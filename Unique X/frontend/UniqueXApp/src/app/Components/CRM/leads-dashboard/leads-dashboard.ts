...
export class LeadsDashboardComponent implements OnInit {
  ...
  // 🟢 helper بسيط لعرض القيم Multi-select (Comma-separated) بشكل مقروء أكتر في الكروت
...
const matchCampCode = campCode === '' || lead.campaignName === campCode;
    ...
    // 🟢 بس الـ 15 حالة الرسمية (9 Qualified + 6 Unqualified) - باقي الحالات القديمة اتشالت من الـ Board خالص
...
this.searchCampaignCode.set('');
  ...
  // 🟢 سكرول أفقي بأسهم يمين وشمال لكل قسم حالة - نفس فكرة Hot Deals في الهوم بالظبط
